...
public class NewsBodyNewsTalk implements INewsBody {
	private static final String TAG = "NewsBodyNewsTalk";
	...
	public String loadHtml(String link) throws IOException {
		...
		try {
			...
			while (null != (s = br.readLine())) { 
				if (s.trim().contains("<div class=\"news_ctxt_area_word\">")) {
					beginFind = true;
				} else if (s.trim().contains("<!--FACEBOOK LIKE-->")) {
					break;
				}
				if (beginFind) {
					sb.append(s.trim());
